...
export const toolsData: Record<string, ToolData> = {
  ...
  'break-even-calculator': {
    ...
    longDescription: 'Calculate your break-even point based on fixed costs, variable costs, and pricing to understand exactly when your business or new investment will become profitable.',
    features: ['Revenue breakeven', 'Unit breakeven', 'Profit projections'],
    faqs: [],
    seo: { title: 'Break-Even Calculator | Quick Lenders', description: 'Calculate your business break-even point for revenue and units sold.' },
