...
export const loanProductData: Record<string, LoanProductData> = {
  'term-loans': {
    ...
    seo: {
      title: 'Business Term Loans | Same-Day Funding Up to $10M',
      description: 'Flexible business term loans from $50K to $10M with same-day funding available. Fixed installments, no early repayment fees, and fast online approval.',
  ...
  'lines-of-credit': {
    ...
    seo: {
      title: 'Business Lines of Credit | Revolving Funds to $10M',
      description: 'Revolving business lines of credit from $50K to $10M. Draw funds as needed, pay interest only on what you use. Same-day funding available.',
  ...
  'asset-backed-loans': {
    ...
    seo: {
      title: 'Asset-Based Business Lending | Loans from $50K to $100M',
      description: 'Leverage receivables, inventory, equipment, or real estate for business funding from $50K to $100M. Competitive rates from 8%. Apply with Quick Lenders.',
  ...
  'equipment-financing': {
    ...
    seo: {
      title: 'Business Equipment Financing | Rates Starting at 7%',
      description: 'Finance any business equipment from $50K to $10M with competitive rates starting at 7%. Terms up to 7 years, equipment serves as collateral for easier approval.',
  ...
  'esop': {
    ...
    seo: {
      title: 'ESOP Financing | Employee Ownership & Tax Benefits',
      description: 'Structure an Employee Stock Ownership Plan with financing from $50K to $10M. Tax advantages, succession planning, and improved retention. Rates from 6%.',
  ...
  'investment-banking': {
    ...
    seo: {
      title: 'Investment Banking Advisory | M&A & Capital Solutions',
      description: 'Strategic investment banking advisory for mid-market businesses. M&A support, capital raises, debt restructuring, and IPO preparation from Quick Lenders.',
  ...
  'bonds': {
    ...
    seo: {
      title: 'Bond Financing | Government, Municipal & Corporate',
      description: 'Issue government, municipal, green, or corporate bonds with maturities from 1 to 20 years. Expert advisory and investor access from Quick Lenders.',
