      ...
      <ToolPageLayout
        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Lenders want to see that your business generates enough revenue to cover the loan payment and still operate. Most require at least $100,000 in annual revenue and 2 years in business. Startups under 1 year face the biggest challenge, but <Link href="/business-loans/equipment-financing" className="text-theme-primary-light font-medium hover:underline">equipment financing</Link> and SBA microloans are available for newer businesses with strong plans. Use our <Link href="/tools/loan-affordability-calculator" className="text-theme-primary-light font-medium hover:underline">loan affordability calculator</Link> to determine how much you can borrow based on your revenue.
            </p>
