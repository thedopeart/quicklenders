      ...
      <ToolPageLayout
        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Most lenders want to see a DSCR of at least 1.15 to 1.25, depending on the loan type. SBA 7(a) loans typically require 1.15 or higher. Bank <Link href="/business-loans/term-loans" className="text-theme-primary-light font-medium hover:underline">term loans</Link> generally look for 1.20 to 1.35. Online lenders and <Link href="/business-loans/lines-of-credit" className="text-theme-primary-light font-medium hover:underline">lines of credit</Link> may accept ratios as low as 1.0 if your other financials are strong. <Link href="/business-loans/equipment-financing" className="text-theme-primary-light font-medium hover:underline">Equipment financing</Link> often focuses more on the asset value than on DSCR.
            </p>
