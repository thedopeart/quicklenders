      ...
      <ToolPageLayout
        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The seven major categories of business financing each serve distinct purposes. <Link href="/business-loans/term-loans" className="text-theme-primary-light font-medium hover:underline">Term loans</Link> provide a lump sum with fixed payments, ideal for one-time investments. <Link href="/business-loans/lines-of-credit" className="text-theme-primary-light font-medium hover:underline">Lines of credit</Link> offer revolving access to capital for ongoing expenses like payroll or inventory. <Link href="/business-loans/equipment-financing" className="text-theme-primary-light font-medium hover:underline">Equipment financing</Link> uses the purchased asset as collateral, typically resulting in lower rates and longer terms.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
