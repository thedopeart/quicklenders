        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Getting denied for a business loan is frustrating, but it is not the end. Most rejections come down to a handful of fixable issues: <strong>credit score</strong> below the lender&apos;s minimum, not enough <strong>time in business</strong>, revenue that does not meet their threshold, or a <strong>debt service coverage ratio</strong> that is too tight. The problem is that many lenders do not explain their reasoning clearly. You get a form letter saying your application was denied, and you are left guessing what went wrong. This tool analyzes common rejection reasons and shows you exactly what to fix based on your profile.
            </p>

            <h3 className="text-xl font-bold text-quicklend-900 mb-3 mt-6">The Most Common Rejection Reasons</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              Credit score is the most frequent barrier. SBA loans typically require <strong>650 to 680+</strong>, banks want <strong>680+</strong>, and even online lenders usually need <strong>550 to 600+</strong>. The good news: credit scores can improve <strong>30 to 50 points in 3 to 6 months</strong> by paying down credit card balances, disputing errors, and maintaining on-time payments. Time in business is the second most common issue. Banks and SBA lenders prefer 2+ years of operating history. If your business is newer, online lenders with 6-month minimums or microloans may be better starting points. Use our <Link href="/tools/dscr-calculator" className="text-theme-primary-light font-medium hover:underline">DSCR calculator</Link> to check if cash flow is the issue.
            </p>
