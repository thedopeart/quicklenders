      ...
      <ToolPageLayout
        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Factor rates look simple: 1.20 means you repay $1.20 for every $1 advanced. But this number hides the true annual cost. A 1.20 factor rate on a 6-month payback works out to roughly 40% APR. The same factor rate on a 12-month payback is closer to 20% APR. The shorter the payback period, the higher the effective APR. Use our <Link href="/tools/factor-rate-to-apr-calculator" className="text-theme-primary-light font-medium hover:underline">factor rate to APR converter</Link> for a more precise conversion, or this calculator to see both the factor rate cost and the estimated APR side by side.
            </p>
