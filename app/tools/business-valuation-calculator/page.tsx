      ...
      <ToolPageLayout
        ...
        seoContent={
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              If you are buying a business, you will likely need financing to cover most of the purchase price. The most common structure combines an SBA 7(a) loan (up to $5 million with 10-year terms), seller financing (where the seller carries 10% to 30% of the price as a note), and a buyer down payment of 10% to 20%. For larger acquisitions, conventional <Link href="/business-loans/term-loans" className="text-theme-primary-light font-medium hover:underline">term loans</Link> or <Link href="/business-loans/investment-banking" className="text-theme-primary-light font-medium hover:underline">investment banking</Link> solutions may be appropriate. If the goal is employee ownership, <Link href="/business-loans/esop" className="text-theme-primary-light font-medium hover:underline">ESOP financing</Link> provides a tax-advantaged structure. Use our <Link href="/tools/sba-loan-payment-calculator" className="text-theme-primary-light font-medium hover:underline">SBA loan calculator</Link> to estimate monthly payments on acquisition financing.
            </p>

            <h3 className="text-xl font-bold text-quicklend-900 mb-3 mt-6">When to Get a Professional Valuation</h3>
            <p className="text-gray-700 leading-relaxed">
              This calculator provides estimates based on industry benchmarks and your inputs. For major transactions, a formal valuation from a Certified Business Appraiser (CBA) or Accredited Senior Appraiser (ASA) is recommended. You should get a professional valuation when selling to outside buyers, bringing in investors, setting up an ESOP, handling divorce or estate planning, or resolving legal disputes. A formal valuation typically costs $3,000 to $10,000 depending on business size and complexity, but it provides defensible numbers that hold up in negotiations and legal proceedings. <Link href="/get-started" className="text-theme-primary-light font-medium hover:underline">Talk to a funding specialist</Link> about acquisition financing options, with no impact to your credit score.
            </p>
          </div>
        }
      >
